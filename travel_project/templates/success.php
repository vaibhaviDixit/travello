...
<body>
	<div class="col-12 mb-4" style="border: 1px solid black;">
		...
		<div class="details">
		 ...
		 $sql="select bookonline.*,package.packageName from bookonline,package where bookonline.packageId=package.id and bookonline.bookId='$id' and bookonline.uid='$uid' ";
